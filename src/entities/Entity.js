...
class Entity {
    ...
    get _dirtyBound() {
        return this.radius !== this.oldRadius || this.x !== this.oldX || this.y !== this.oldY || (this.checkTrail && (this.prevX !== this.x || this.prevY !== this.y));
    }
...
Entity.addSyncKeys(
    ...
    { key: "rot", type: "float", update: true, serverKey: true, sendMap: v => utils.modFix(v, Math.PI * 2) },  // Map the rotation to 0 to 2 * pi
