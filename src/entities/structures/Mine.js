...
class Mine extends WorkingStructure {
    get resource() { return this.structure.resource; }
    get resourceIndex() { return resources.resources.indexOf(this.resource); }

    get laborDemand() { return this.resource.laborDemand; }

    get maxCount() { return resources.mineMaxCount; }

    get generationRate() { return this.resource.generationRate; }

    get generationSupply() { return this.hostPlanet.resources[this.resourceIndex]; }
