...
upgrades.upgrades = [
  ...
  [
    { structureId: "missile-factory" },
    { structureId: "sniper-turret" },
    { structureId: "ground-wall" },
  ],
  [
    { structureId: "sniper-factory" },
    { structureId: "wall-strong" },
    { structureId: "missile-turret" },
  ],
  [
  ...
  [
    { structureId: "heal-factory" },
    { structureId: "teleport-factory" },
    { structureId: "shield-factory" },
  ],
...
for (let upgradeOptions of upgrades.upgrades) {
  for (let upgrade of upgradeOptions) {
    if (upgrade.structureId) {
      ...
      if (upgrade.structure == null)
        throw new Error(`Invalid structure ID ${upgrade.structureId}.`);
