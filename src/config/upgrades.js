...
upgrades.upgrades = [
	...
	[
		...
		{ machineGunDamage: 1.08, minigunDamage: 1.1, label: 'upgrade-machine-gun' },
		{ structureId: 'ied' }
	], // Tier 3  // { cost: 0.9 }
	[
	...
	[
		...
		{ machineGunLife: 1.05, minigunLife: 1.05, shotgunLife: 1.3, label: 'upgrade-weapon-range' }
	...
	[
		...
		{ shotgunAmmo: 3, minigunAmmo: 3, antiFollowAmmo: 3, sniperAmmo: 3, label: 'upgrade-tripple-ammo' }
