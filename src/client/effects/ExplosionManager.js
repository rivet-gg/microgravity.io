...
class ExplosionManager {
    ...
    spawnExplosion(x, y, size, speed = 80) {
        ...
        let explosionMagnitude = (size - explosionMinVolumeSize) / (explosionMaxVolumeSize - explosionMinVolumeSize);
        ...
        let soundId = assets.playSound(isLarge ? "explosion-large" : "explosion-small", explosionVolume, x, y);
