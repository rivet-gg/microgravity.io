...
const InputHandler = {
    ...
    key(...keys) {
        ...
        for (let key of keys) {
            ...
            if (value) // If not null and is true
                return true;
        }
    ...
    /** @returns {number} */ get leftJoystickX() { return this.axisValue(0); },
    /** @returns {number} */ get leftJoystickY() { return this.axisValue(1); },

    /** @returns {number} */ get rightJoystickX() { return this.axisValue(2); },
    /** @returns {number} */ get rightJoystickY() { return this.axisValue(3); },

    /** @returns {number} */ get arrowsX() { return this.axisValue(4); },
    /** @returns {number} */ get arrowsY() { return this.axisValue(5); },

    /** @returns {number} */ get leftBumper1() { return this.buttonValue(4); },
    /** @returns {boolean} */ get leftBumper1Pressed() { return this.buttonPressed(4); },

    /** @returns {number} */ get leftBumper2() { return this.buttonValue(6); },
    /** @returns {boolean} */ get leftBumper2Pressed() { return this.buttonPressed(6); },

    /** @returns {number} */ get rightBumper1() { return this.buttonValue(5); },
    /** @returns {boolean} */ get rightBumper1Pressed() { return this.buttonPressed(5); },

    /** @returns {number} */ get rightBumper2() { return this.buttonValue(7); },
    /** @returns {boolean} */ get rightBumper2Pressed() { return this.buttonPressed(7); },

    /** @returns {number} */ get buttonA() { return this.buttonValue(0); },
    /** @returns {boolean} */ get buttonAPressed() { return this.buttonPressed(0); },

    /** @returns {number} */ get buttonB() { return this.buttonValue(1); },
    /** @returns {boolean} */ get buttonBPressed() { return this.buttonPressed(1); },

    /** @returns {number} */ get buttonX() { return this.buttonValue(2); },
    /** @returns {boolean} */ get buttonXPressed() { return this.buttonPressed(2); },

    /** @returns {number} */ get buttonY() { return this.buttonValue(3); },
    /** @returns {boolean} */ get buttonYPressed() { return this.buttonPressed(3); },
