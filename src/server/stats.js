...
module.exports = {
    ...
    tallyAdReward() { this.tally("ad-rewards"); },
    tallyPlayerKill() { this.tally("player-kills"); },
    tallyBotKill() { this.tally("bot-kills"); },
    tallyAsteroidDestroy() { this.tally("asteroid-destroys"); },
    tallyFire(weaponId) { this.tally(`fire:${weaponId}`); },
    tallyPoints(type, points) { this.tally(`points:${type}`, points); },
    tallyBuild(structureId) { this.tally(`build:${structureId}`); },
    tallyCreateAlliance(name) {
        this.tally("alliances-created");
        this.hashTally("alliance-names", name);
    },
    tallyJoinAlliance() { this.tally("alliance-joins"); },
    tallyMessage() { this.tally("messages"); },
    tallyAdminFails() { this.tally("admin-fails"); },
