...
import {
  ListMutualFriendsInput,
  ListMutualFriendsOutput,
} from "../models/models_0";
import {
  deserializeAws_restJson1ListMutualFriendsCommand,
  serializeAws_restJson1ListMutualFriendsCommand,
...
export class ListMutualFriendsCommand extends $Command<ListMutualFriendsCommandInput, ListMutualFriendsCommandOutput, IdentityServiceClientResolvedConfig> {
  // Start section: command_properties
  // End section: command_properties

  constructor(readonly input: ListMutualFriendsCommandInput) {
  ...
  resolveMiddleware(
  ...
  ): Handler<ListMutualFriendsCommandInput, ListMutualFriendsCommandOutput> {
    ...
    const handlerExecutionContext: HandlerExecutionContext = {
      ...
      inputFilterSensitiveLog:
        ListMutualFriendsInput.filterSensitiveLog,
      outputFilterSensitiveLog:
        ListMutualFriendsOutput.filterSensitiveLog,
    }
