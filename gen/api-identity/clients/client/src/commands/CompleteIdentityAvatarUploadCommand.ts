...
import {
  CompleteIdentityAvatarUploadInput,
  CompleteIdentityAvatarUploadOutput,
} from "../models/models_0";
import {
  deserializeAws_restJson1CompleteIdentityAvatarUploadCommand,
  serializeAws_restJson1CompleteIdentityAvatarUploadCommand,
 ...
 *
 */
export class CompleteIdentityAvatarUploadCommand extends $Command<CompleteIdentityAvatarUploadCommandInput, CompleteIdentityAvatarUploadCommandOutput, IdentityServiceClientResolvedConfig> {
  // Start section: command_properties
  // End section: command_properties

  constructor(readonly input: CompleteIdentityAvatarUploadCommandInput) {
  ...
  resolveMiddleware(
  ...
  ): Handler<CompleteIdentityAvatarUploadCommandInput, CompleteIdentityAvatarUploadCommandOutput> {
    ...
    const handlerExecutionContext: HandlerExecutionContext = {
      ...
      inputFilterSensitiveLog:
        CompleteIdentityAvatarUploadInput.filterSensitiveLog,
      outputFilterSensitiveLog:
        CompleteIdentityAvatarUploadOutput.filterSensitiveLog,
    }
