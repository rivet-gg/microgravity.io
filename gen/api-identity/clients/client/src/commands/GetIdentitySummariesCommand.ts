...
import {
  deserializeAws_restJson1GetIdentitySummariesCommand,
  serializeAws_restJson1GetIdentitySummariesCommand,
 ...
 *
 */
export class GetIdentitySummariesCommand extends $Command<GetIdentitySummariesCommandInput, GetIdentitySummariesCommandOutput, IdentityServiceClientResolvedConfig> {
  // Start section: command_properties
  // End section: command_properties

  constructor(readonly input: GetIdentitySummariesCommandInput) {
  ...
  resolveMiddleware(
  ...
  ): Handler<GetIdentitySummariesCommandInput, GetIdentitySummariesCommandOutput> {
    ...
    const handlerExecutionContext: HandlerExecutionContext = {
      ...
      inputFilterSensitiveLog:
        GetIdentitySummariesInput.filterSensitiveLog,
      outputFilterSensitiveLog:
        GetIdentitySummariesOutput.filterSensitiveLog,
    }
