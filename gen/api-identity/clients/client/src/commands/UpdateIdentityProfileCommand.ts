...
import {
  deserializeAws_restJson1UpdateIdentityProfileCommand,
  serializeAws_restJson1UpdateIdentityProfileCommand,
 ...
 *
 */
export class UpdateIdentityProfileCommand extends $Command<UpdateIdentityProfileCommandInput, UpdateIdentityProfileCommandOutput, IdentityServiceClientResolvedConfig> {
  // Start section: command_properties
  // End section: command_properties

  constructor(readonly input: UpdateIdentityProfileCommandInput) {
  ...
  resolveMiddleware(
  ...
  ): Handler<UpdateIdentityProfileCommandInput, UpdateIdentityProfileCommandOutput> {
    ...
    const commandName = "UpdateIdentityProfileCommand";
    const handlerExecutionContext: HandlerExecutionContext = {
      logger,
      clientName,
      commandName,
      inputFilterSensitiveLog:
        UpdateIdentityProfileInput.filterSensitiveLog,
      outputFilterSensitiveLog:
        UpdateIdentityProfileOutput.filterSensitiveLog,
    }
