...
import {
  deserializeAws_restJson1GetPartyProfileCommand,
  serializeAws_restJson1GetPartyProfileCommand,
 ...
 *
 */
export class GetPartyProfileCommand extends $Command<GetPartyProfileCommandInput, GetPartyProfileCommandOutput, PartyServiceClientResolvedConfig> {
  // Start section: command_properties
  // End section: command_properties

  constructor(readonly input: GetPartyProfileCommandInput) {
  ...
  resolveMiddleware(
  ...
  ): Handler<GetPartyProfileCommandInput, GetPartyProfileCommandOutput> {
    ...
    const handlerExecutionContext: HandlerExecutionContext = {
      ...
      inputFilterSensitiveLog:
        GetPartyProfileInput.filterSensitiveLog,
      outputFilterSensitiveLog:
        GetPartyProfileOutput.filterSensitiveLog,
    }
