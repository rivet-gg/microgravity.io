...
export declare type ServiceInputTypes = FindLobbyCommandInput | JoinLobbyCommandInput | ListLobbiesCommandInput | ListRegionsCommandInput | LobbyReadyCommandInput | PlayerConnectedCommandInput | PlayerDisconnectedCommandInput | SetLobbyClosedCommandInput;
export declare type ServiceOutputTypes = FindLobbyCommandOutput | JoinLobbyCommandOutput | ListLobbiesCommandOutput | ListRegionsCommandOutput | LobbyReadyCommandOutput | PlayerConnectedCommandOutput | PlayerDisconnectedCommandOutput | SetLobbyClosedCommandOutput;
...
declare type MatchmakerServiceClientConfigType = PartialBy<Partial<__SmithyConfiguration<__HttpHandlerOptions>> & ClientDefaults & CustomEndpointsInputConfig & RetryInputConfig & HostHeaderInputConfig & UserAgentInputConfig, "endpoint">;
/**
...
declare type MatchmakerServiceClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> & Required<ClientDefaults> & CustomEndpointsResolvedConfig & RetryResolvedConfig & HostHeaderResolvedConfig & UserAgentResolvedConfig;
/**
...
export declare class MatchmakerServiceClient extends __Client<__HttpHandlerOptions, ServiceInputTypes, ServiceOutputTypes, MatchmakerServiceClientResolvedConfig> {
    /**
