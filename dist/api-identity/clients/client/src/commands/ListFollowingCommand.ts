...
import {
  deserializeAws_restJson1ListFollowingCommand,
  serializeAws_restJson1ListFollowingCommand,
...
export class ListFollowingCommand extends $Command<ListFollowingCommandInput, ListFollowingCommandOutput, IdentityServiceClientResolvedConfig> {
  // Start section: command_properties
  // End section: command_properties

  constructor(readonly input: ListFollowingCommandInput) {
  ...
  resolveMiddleware(
  ...
  ): Handler<ListFollowingCommandInput, ListFollowingCommandOutput> {
    ...
    const handlerExecutionContext: HandlerExecutionContext = {
      ...
      inputFilterSensitiveLog:
        ListFollowingInput.filterSensitiveLog,
      outputFilterSensitiveLog:
        ListFollowingOutput.filterSensitiveLog,
    }
